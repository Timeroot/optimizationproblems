...
$C_{10}$ is the **real Grothendieck constant** $K_G^{\mathbb R}$.
...
$$
\max_{\substack{u_1,\dots,u_m,  v_1,\dots,v_n \in S^{\infty}}}
\ \sum_{i=1}^m \sum_{j=1}^n a_{ij} \langle u_i, v_j\rangle
\ \le\ 
C
\max_{\varepsilon_1,\dots,\varepsilon_m, \delta_1,\dots,\delta_n  = \pm 1}
...
$u_i,v_j \in S^{d-1}$ for some sufficiently large finite dimension $d$).
...
- [Dav1984] Davie, A. M. *Lower bound for $K_G$.* Unpublished note (1984).
