...
We define $C_{21}$ to be the smallest constant such that the **classical Berry–Esseen inequality**
$$
\Delta_n := \sup_{x\in\mathbb R}\bigl|F_n(x)-\Phi(x)\bigr|
\ \le\
C_{21}\,\frac{\beta_3}{\sqrt n}
...
* **Zolotarev’s conjecture:** It is conjectured that $C_{21}=c_E$, i.e. the Esseen lower bound is sharp. This is sometimes attributed to Zolotarev (1967). See e.g. [vB1972], [KS2009], [Tyu2009] for discussion.
* **How the bound $0.4690$ is obtained:** Shevtsova [She2013] proves the structural estimate
  ...
  $$
  which in particular implies $C_{21}\le 0.4690$.
